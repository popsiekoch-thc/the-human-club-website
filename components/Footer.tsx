  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 'clamp(56px, 10vw, 156px)', lineHeight: 0.88, letterSpacing: '-0.04em', margin: '0 0 44px', color: 'var(--shell)', paddingTop: 56, borderTop: '1px solid rgba(225,225,213,0.4)' }}>
          Say&nbsp;hello,<br />
