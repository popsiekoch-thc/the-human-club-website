...
export default async function THCRadio() {
  ...
  return (
    <section
      id="radio"
      style={{ background: 'var(--page-black)', color: 'var(--shell)', padding: '0 40px 100px', scrollMarginTop: 76 }}
    >
      <div className="section-head" style={{ borderTopColor: 'var(--border)' }}>
        <div className="num" style={{ color: 'var(--shell)' }}>— Page 04 / Radio</div>
        <h2 style={{ color: 'var(--shell)' }}>THC&nbsp;<em>Radio.</em></h2>
        <div className="aside" style={{ color: 'rgba(225,225,213,0.65)' }}>
      ...
      <div
        ...
        style={{
          ...
          color: 'var(--shell)',
          border: '1px solid rgba(225,225,213,0.15)',
      ...
      >
        <div style={{ width: 180, height: 180, background: 'var(--page-black)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--shell)' }}>
        ...
        <div>
          ...
          <div style={{ height: 4, background: 'rgba(225,225,213,0.18)', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'flex-end' }}>
          <a href={SC_URL} target="_blank" rel="noopener noreferrer" aria-label="Play THC Radio on SoundCloud"
             style={{ width: 64, height: 64, borderRadius: '50%', background: 'var(--page-black)', color: 'var(--shell)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>
            ▶
          </a>
      ...
      <div
        className="mix-list"
        style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 4, marginTop: 24, borderTop: '1px solid var(--border)' }}
      >
        {mixes.map((mix, i) => (
          <a
            key={mix.id}
            ...
            style={{
              padding: 22,
              borderRight: i < mixes.length - 1 ? '1px solid var(--border)' : '0',
              minHeight: 160,
              display: 'flex',
          ...
          >
            ...
            <div style={{ fontFamily: 'var(--font-ui)', fontSize: 12, opacity: 0.75, marginTop: 4, color: 'var(--shell)' }}>
              — {mix.artist}
            </div>
          </a>
        ))}
